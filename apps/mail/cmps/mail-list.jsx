            ...
            {mails.map(mail =>
                <li className={`mail-row ${mail.isRead}`} key={mail.id}>
                    <button onClick={() => onStarred(mail)} className="star-button">
                        <img className={`empty-star ${mail.isStarred}`} src="img/star.svg" alt="" />
                        <img className={`yellow-star ${mail.isStarred}`} src="img/star-yellow.svg" alt="" />
                    </button>
                    <button onClick={() => onLabeled(mail)} className="label-button">
                        <img className={`empty-label ${mail.isImportant}`} src="img/label.svg" alt="" />
                        <img className={`yellow-label ${mail.isImportant}`} src="img/yellow-label.svg" alt="" />
                    </button>
